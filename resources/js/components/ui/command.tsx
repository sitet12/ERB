...
function CommandList({
  ...
  React.useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      // Si on est en haut et on scroll vers le haut, ou en bas et on scroll vers le bas
      // On laisse l'événement se propager (fermer le popover)
      if ((isAtTop && isScrollingUp) || (isAtBottom && isScrollingDown)) {
        return;
      }

      // Sinon, on empêche la propagation pour que le scroll fonctionne dans la liste
      e.stopPropagation();
    };
